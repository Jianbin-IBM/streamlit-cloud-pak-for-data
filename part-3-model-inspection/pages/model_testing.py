    ...
    with col2:
        with st.form("my_form"):
            ...
            submitted = st.form_submit_button("Predict",
                                              help="Click here to get predictions for the row selected on the left or the values entered below.")
            ...
            if grid_response['selected_rows']:
                ...
                if submitted:
                    (proba, class_pred), error_msg = cpd_helpers.get_deployment_prediction(headers, deployment_details,
                                                                                           payload)
